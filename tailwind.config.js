    ...
    typography: (theme) => ({
      ...
      DEFAULT: {
        css: {
          ...
          '--tw-prose-underline': theme('colors.amber.600 / 0.2'),
          '--tw-prose-underline-hover': theme('colors.amber.600'),
          ...
          '--tw-prose-invert-underline': theme('colors.amber.500 / 0.3'),
          '--tw-prose-invert-underline-hover': theme('colors.amber.500'),
